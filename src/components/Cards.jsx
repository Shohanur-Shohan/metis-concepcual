...
const Cards = () => {
    return (
        // <!-- Card Section -->
        <div className="py-14 md:py-[100px] w-full bg-[#F9FAFB]">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 sm:gap-4">
                    ...
                    <div className="p-4 md:p-5">
                        <div className='text-center'>
                            ...
                            <Image width={300} height={300} className="w-full md:px-[15%] px-[10%]" src="/images/image2.png" alt="work"/>
                    ...
                    <div className="p-4 md:p-5">
                        <div className='text-center'>
                            ...
                            <Image width={300} height={300} className="w-full md:px-[15%] px-[10%]" src="/images/financial-report.png" alt="work"/>
