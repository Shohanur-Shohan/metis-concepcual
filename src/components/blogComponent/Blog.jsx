            ...
            <div className="grid grid-cols-12 gap-[30px]">
              {/* blog item */}
              {
                ...
                return(
                  ...
                  <div key={id} className="col-span-12 px-4 mb-[5rem] md:col-span-6 xl:col-span-4">
                    <a className="relative block max-w-md mx-auto group" href="#">
                      <div className="absolute bottom-0 left-0 w-full p-5">
                        <div className="p-5  shadow-lg transition ease-in-out delay-[4000ms] bg-white rounded-xl mb-[-65px]">
                          ...
                          <div className="items-center justify-end hidden mt-5 font-semibold text-orange-900 group-hover:flex">
                      ...
                      <img
                        className="block w-full rounded-lg h-80"
                        src={item?.imgCDN}
                        alt=""
                      />
                    </a>
