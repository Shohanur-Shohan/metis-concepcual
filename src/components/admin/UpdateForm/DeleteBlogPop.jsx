...
const DeleteBlogPop = ({item}) => {
    ...
    const handleDeleteBlog = async (ID) => {
        // console.log(ID);
        try {
            let res = await axios.delete(`/api/dashboard/blog/delete?id=${ID}`);
            if(res?.status === 200) {
