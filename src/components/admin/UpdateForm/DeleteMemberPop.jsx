...
const DeleteMemberPop = (props) => {

    const memberID = props.data;
    
    const deleteMember = async (ID)=>{
        try {
            let res = await axios.delete(`/api/dashboard/member/delete?id=${ID}`);
            if(res?.status == 200) {
