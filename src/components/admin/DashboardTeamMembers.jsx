    ...
    return (
        <div className="w-full">
            <div className="flex justify-center h-[fit-content] pt-10 ">
                <div className="w-full p-6 px-2 pb-[1000px] overflow-x-scroll overflow-y-hidden md:overflow-hidden">
                    <table className="w-full text-left table-auto border-[1px] border-gray-100">
                        <thead >
                        <tr>
                            <th className="p-4 border-y border-blue-gray-100 bg-blue-gray-50/50">
                            <p className="block font-sans text-sm antialiased font-normal leading-none text-blue-gray-900 opacity-70">Profile</p>
                            </th>
                            <th className="p-4 border-y border-blue-gray-100 bg-blue-gray-50/50">
                                ...
                                <tr key={id}>
                                    <td className="p-4 border-b border-blue-gray-50">
                                        <div className="flex items-center gap-3">
                                            <Image width={100} height={100} src={item?.imgCDN} className="relative inline-block object-contain object-center w-12 h-12 p-1 border rounded-full border-blue-gray-50 bg-blue-gray-50/50" alt="profile img"/>
                                        </div>
                                        </td>
                                        <td className="p-4 border-b border-blue-gray-50">
                                        <p className="block font-sans text-sm antialiased font-bold leading-normal text-blue-gray-900">{item?.name}</p>
                                        </td>
                                        <td className="p-4 border-b border-blue-gray-50">
                                        <p className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">{item?.role}</p>
                                        </td>
                                        <td className="p-4 border-b border-blue-gray-50">
                                        <div className="flex items-center gap-3">
