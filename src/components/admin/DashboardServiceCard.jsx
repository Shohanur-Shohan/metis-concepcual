import DeleteServicePop from "./UpdateForm/DeleteServicePop";
import UpdateServicePop from "./UpdateForm/UpdateServicePop";


const DashboardServiceCard = ({item}) => {
        ...
        <tr className="">
            <td className="p-4 border-b border-blue-gray-50">
                <div className="flex items-center gap-3">
                    <img src={item?.imgCDN} alt={item?.title} className="relative inline-block object-contain object-center w-48 h-48 p-1 rounded-md bg-blue-gray-50/50"/>
                </div>
                </td>
                <td className="p-4 border-b border-blue-gray-50">
                    <p className="block font-sans text-sm antialiased font-bold leading-normal text-blue-gray-900">{item?.title}</p>
                </td>
                <td className="p-4 border-b border-blue-gray-50">
                <p className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">{item?.imgCDN}</p>
            </td>
            <td className="flex items-center p-4 border-b border-blue-gray-50">
                  {/*update popup  */}
