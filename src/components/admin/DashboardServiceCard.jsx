        ...
        <tr className="">
            <td className="p-4 border-b border-blue-gray-50">
                <div className="flex items-center gap-3">
                    <img src={service?.imgCDN} alt={service?.title} className="relative inline-block object-contain object-center w-48 h-48 p-1 rounded-md bg-blue-gray-50/50"/>
                </div>
                </td>
                <td className="p-4 border-b border-blue-gray-50">
                    <p className="block font-sans text-sm antialiased font-bold leading-normal text-blue-gray-900">{service?.title}</p>
                </td>
                <td className="p-4 border-b border-blue-gray-50">
                <p className="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">{service?.imgCDN}</p>
            </td>
